...
public class CharaClassRanger extends CharaClass 
{
	public void getClassDetail()
	{
		className = "Ranger";
		classDesc = "The ranger is a warrior and a woodsman who is skilled with weapons and is knowledgeable in the ways of the forest. "
