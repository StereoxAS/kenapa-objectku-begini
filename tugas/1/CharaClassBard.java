...
public class CharaClassBard extends CharaClass 
{
	public static String getClassDetail()
	{
		return
		CharaClass.setClassName("Bard\n\n") + 
		CharaClass.setClassDesc("The Bard is a rogue, but is very different from the Thief. "
